    ...
    ui(new Ui::MainWindow)
{
    ...
    // Map Setup
    ui->webView_4->hide();
    ui->webView_4->load(QUrl("file:/C:/Users/Ernest Curioso/Documents/Qt Projects/UAVProject/map.html"));
...
void MainWindow::onMapLoaded()
{
    ...
    addUAV("UAV1", "[[34.239, -118.529],[34.239, -118.554]]", "50000", 1, 15);
    addUAV("UAV2", "[[34.239, -118.529],[34.183, -118.312]]", "15000", 2, 30);
    addUAV("UAV3", "[[34.239, -118.529],[34.190, -118.603]]", "20000", 3, 60);
    addUAV("UAV4", "[[34.239, -118.529],[34.156, -118.437]]", "30000", 4, 20);
...
// Shows UAV Window
void MainWindow::showUAVWindow(QString name)
{
