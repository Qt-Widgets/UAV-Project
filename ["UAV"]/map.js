...
function listener1 () {
    UAVs[1].on('click', function() {
        JSBridge.showUAVWindow("UAV1");
    });
}
function listener2 () {
    UAVs[2].on('click', function() {
        JSBridge.showUAVWindow("UAV2");
    });
}
function listener3 () {
    UAVs[3].on('click', function() {
        JSBridge.showUAVWindow("UAV3");
    });
}
function listener4 () {
    UAVs[4].on('click', function() {
        JSBridge.showUAVWindow("UAV4");
    });
}
function listener5 () {
    UAVs[5].on('click', function() {
        JSBridge.showUAVWindow("UAV5");
    });
}
function listener6 () {
    UAVs[6].on('click', function() {
        JSBridge.showUAVWindow("UAV6");
    });
}
function listener7 () {
    UAVs[7].on('click', function() {
        JSBridge.showUAVWindow("UAV7");
    });
}
function listener8 () {
    UAVs[8].on('click', function() {
        JSBridge.showUAVWindow("UAV8");
    });
}
function listener9 () {
    UAVs[9].on('click', function() {
        JSBridge.showUAVWindow("UAV9");
    });
}
function listener10 () {
    UAVs[10].on('click', function() {
        JSBridge.showUAVWindow("UAV10");
    });
}
//END Listeners
